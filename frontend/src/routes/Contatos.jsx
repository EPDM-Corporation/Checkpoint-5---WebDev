           ...
           <form class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" class="w-full rounded-[10px] bg-gray-200 px-4 py-2 outline-none" required/>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="email" class="w-full rounded-[10px] bg-gray-200 px-4 py-2 outline-none" required/>
                    </div>
                    <div>
                        <label class="block mb-1 font-montserrat">Telefone *</label>
                        <input type="tel" class="w-full rounded-[10px] bg-gray-200 px-4 py-2 outline-none" required/>
                    </div>
                </div>
                <div>
                    <label class="block mb-1 font-montserrat">Sua mensagem *</label>
                    <textarea rows="6" class="w-full rounded-[10px] bg-gray-200 px-4 py-3 outline-none resize-none" required></textarea>
                </div>
